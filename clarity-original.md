...
Assure that salary policies are soundly administered and that job analysis elements, including job content questionnaires, evaluations, and salary ranges are kept up-to-date, both to maintain the integrity of the Program and enhance the accuracy of our direct labor rate estimates.
...
COMPANY’s Compensation Program has four principal components:
